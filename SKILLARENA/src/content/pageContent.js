export const PAGE_SECTIONS = {
  terms: [
    {
      heading: '1. Welcome to Skill Arena',
      paragraphs: [
        'Skill Arena is a free learning platform where you can take courses, join live 1v1 and 3v3 skill battles, chat with friends, and climb the global leaderboard. By creating an account or using the platform, you agree to these Terms of Service.',
        'If you do not agree with these terms, please do not use Skill Arena.',
      ],
    },
    {
      heading: '2. Your account',
      paragraphs: [
        'You are responsible for keeping your login details secure and for all activity that happens under your account. Provide accurate information when you sign up and update it if anything changes.',
      ],
      list: [
        'You must be at least 13 years old to use Skill Arena.',
        'One person may not maintain more than one account for competitive advantage.',
        'We may suspend or remove accounts that violate these terms or harm the community.',
      ],
    },
    {
      heading: '3. Learning and battles',
      paragraphs: [
        'Courses, lessons, XP, badges, and leaderboard rankings are provided to help you learn and track progress. Battle results reflect performance in real-time matches and may affect your rank and public profile.',
        'Skill Arena uses matchmaking and moderation systems to keep competition fair. Attempting to cheat, exploit bugs, harass other players, or manipulate rankings is strictly prohibited.',
      ],
    },
    {
      heading: '4. Community standards',
      list: [
        'Treat other learners, teammates, and opponents with respect.',
        'Do not share harmful, abusive, or illegal content in chat, profiles, or replays.',
        'Do not impersonate other users or Skill Arena staff.',
        'Do not scrape, reverse engineer, or disrupt platform services.',
      ],
    },
    {
      heading: '5. Free platform',
      paragraphs: [
        'Skill Arena is free to use. We do not require a credit card to sign up, and core learning and battle features remain accessible without paywalls. We may introduce optional features in the future, but our mission is to keep learning open and competitive for everyone.',
      ],
    },
    {
      heading: '6. Changes and contact',
      paragraphs: [
        'We may update these terms as Skill Arena grows. When we make meaningful changes, we will post the updated version on this page with a revised effective date.',
        'Questions about these terms can be sent to legal@skillarena.com.',
      ],
      note: 'Effective date: January 1, 2028',
    },
  ],
  ...
  privacy: [
    {
      ...
      paragraphs: [
        'Skill Arena is built for learners who want to study, compete, and connect. This Privacy Policy explains what information we collect, why we collect it, and the choices you have.',
      ],
    },
    {
      heading: 'Information we collect',
      list: [
        'Account details such as your name, email address, and profile settings.',
        'Learning activity including course progress, XP, completed lessons, and skill graph data.',
        'Battle data such as match history, rankings, replays, and performance statistics.',
        'Community interactions including messages, squad memberships, and reports.',
        'Technical data such as device type, browser, IP address, and usage logs used to keep the platform secure and reliable.',
      ],
    },
    {
      heading: 'How we use information',
      list: [
        'Provide courses, battles, chat, leaderboards, and personalized learning paths.',
        'Match you with opponents and teammates at an appropriate skill level.',
        'Improve platform performance, detect abuse, and enforce fair play.',
        'Send important account, security, and product updates.',
        'Analyze aggregated trends to make Skill Arena better for all learners.',
      ],
    },
    {
      heading: 'Sharing and retention',
      paragraphs: [
        'We do not sell your personal information. We share data only with trusted service providers that help us operate Skill Arena, when required by law, or when necessary to protect users and the platform.',
        'We retain information for as long as your account is active or as needed to provide services, comply with legal obligations, and resolve disputes.',
      ],
    },
    {
      heading: 'Your choices',
      list: [
        'Update profile and account settings at any time.',
        'Request access to or deletion of your personal data by contacting privacy@skillarena.com.',
        'Adjust cookie preferences as described in our Cookie Policy.',
        'Opt out of non-essential communications in your notification settings.',
      ],
      note: 'Contact: privacy@skillarena.com',
    },
  ],
  ...
  cookies: [
    {
      ...
      paragraphs: [
        'Cookies are small text files stored on your device. Skill Arena uses cookies and similar technologies to remember your preferences, keep you signed in, and understand how the platform is used.',
      ],
    },
    {
      ...
      list: [
        ...
        'Preference cookies that remember language, theme, and notification settings.',
        'Analytics cookies that help us measure traffic, performance, and feature usage in aggregate.',
        'Session cookies that keep your account active while you learn or battle.',
      ],
    },
    {
      heading: 'Managing cookies',
      paragraphs: [
        'You can control cookies through your browser settings. Blocking essential cookies may prevent parts of Skill Arena from working correctly, including sign-in and match participation.',
        'Where required, we will ask for consent before using non-essential cookies.',
      ],
      note: 'Questions: privacy@skillarena.com',
    },
  ],
